...
Register-ArgumentCompleter -Native -CommandName 'wutag' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        ...
        'wutag;set' {
            ...
            [CompletionResult]::new('-V', 'V', [CompletionResultType]::ParameterName, 'Specify an array of value(s) to add to tag(s)')
            [CompletionResult]::new('--value', 'value', [CompletionResultType]::ParameterName, 'Specify an array of value(s) to add to tag(s)')
        ...
        'wutag;edit' {
            ...
            [CompletionResult]::new('-a', 'a', [CompletionResultType]::ParameterName, 'Modify all tags that have the given value')
            [CompletionResult]::new('--all', 'all', [CompletionResultType]::ParameterName, 'Modify all tags that have the given value')
        ...
        'wutag;repair' {
            [CompletionResult]::new('-m', 'm', [CompletionResultType]::ParameterName, 'Manually set a file''s new location')
            ...
            [CompletionResult]::new('--restrict', 'restrict', [CompletionResultType]::ParameterName, 'Restrict the repairing to the CWD, or the path given with -d')
            [CompletionResult]::new('-D', 'D', [CompletionResultType]::ParameterName, 'Manually update a directory''s contents')
            [CompletionResult]::new('--directory', 'directory', [CompletionResultType]::ParameterName, 'Manually update a directory''s contents')

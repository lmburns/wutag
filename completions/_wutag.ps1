...
Register-ArgumentCompleter -Native -CommandName 'wutag' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        ...
        'wutag;rm' {
            ...
            [CompletionResult]::new('-V', 'V', [CompletionResultType]::ParameterName, 'Specify a value to remove from from a tag. Requires --tag')
            [CompletionResult]::new('--value', 'value', [CompletionResultType]::ParameterName, 'Specify a value to remove from from a tag. Requires --tag')
            ...
            [CompletionResult]::new('-t', 't', [CompletionResultType]::ParameterName, 'Specify a tag to remove from the database (default behavior)')
            [CompletionResult]::new('--tag', 'tag', [CompletionResultType]::ParameterName, 'Specify a tag to remove from the database (default behavior)')

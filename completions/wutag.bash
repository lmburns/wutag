_wutag() {
    ...
    case "${cmd}" in
        wutag)
            opts=" -d -m -r -i -g -n -h -V  --dir --max-depth --registry --case-insensitive --global --no-color --help --version  list set rm clear search cp edit print-completions clean-cache"

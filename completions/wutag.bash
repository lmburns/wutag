...
_wutag() {
    ...
    case "${cmd}" in
        ...
        wutag__clean__cache)
            ...
            ;;
        wutag__clear)
            opts="-a -V -h -v -g --all --values --help --verbose --global <pattern>"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        wutag__edit)
            ...
            ;;
        wutag__info)
            opts="-m -f -r -h -v -g --mean --full --raw --help --verbose --global"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        wutag__list__tags)
            ...
            ;;
        wutag__merge)
            opts="-V -p -h -v -g --values --pattern --help --verbose --global <dest> <source>..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        wutag__print__completions)
            ...
            ;;
        wutag__repair)
            opts="-d -c -R -r -m -D -u -h -v -g --dry-run --crawl --remove --restrict --manual --directory --unmodified --help --verbose --global"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        wutag__view)
            ...
            ;;
        wutag__xattr)
            opts="-h -v -g --help --verbose --global <pattern> <tags>..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi

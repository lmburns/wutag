...
Register-ArgumentCompleter -Native -CommandName 'wutag' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'wutag' {
            ...
            [CompletionResult]::new('-u', 'u', [CompletionResultType]::ParameterName, 'Open a TUI to manage tags')
            [CompletionResult]::new('--ui', 'ui', [CompletionResultType]::ParameterName, 'Open a TUI to manage tags')

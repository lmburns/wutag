...
//         assert_eq!(ret.directory(),
// &env::current_dir()?.display().to_string());         assert_eq!(ret.mime(),
// &MimeType::from_str("text/markdown")?);
//
//         #[cfg(all(
//             feature = "file-flags",
//             target_family = "unix",
...
//         // === hash ===
//         let files =
//             reg.files_by_hash(hash::blake3_hash(mfile.display().to_string(),
// None)?.to_string())?;         first_idx!(files);
//
//         // === Mime ===
...
//             hash::blake3_hash(mfile.display().to_string(),
// None)?.to_string(),         )?;
//         assert_eq!(count, 1);
//
//         Ok(())
...
//     setup_dbfn(|reg| {
//         let test = PathBuf::from("./README.md");
//         let ftag = FileTag::new(FileId::new(1), TagId::new(1),
// ValueId::new(1));
//
...
//         let ftag = FileTag::new(FileId::new(1), TagId::new(1),
// ValueId::new(1));         reg.delete_filetag(&ftag)?;
//
...
//
//         let ftag2 = FileTag::new(FileId::new(1), TagId::new(2),
// ValueId::new(2));         reg.insert_filetag(&ftag2)?;
//
...
//     setup_dbfn_wfiletag(|reg| {
//         let ftag = FileTag::new(FileId::new(1), TagId::new(1),
// ValueId::new(1));         assert!(reg.filetag_exists(&ftag)?);
//
//         let ftag2 = FileTag::new(FileId::new(1), TagId::new(2),
// ValueId::new(2));         reg.insert_filetag(&ftag2)?;
//

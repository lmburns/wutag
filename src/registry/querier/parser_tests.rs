...
//                   - \x1B[1;32ml\x1B[0m: swap the meaning of \x1B[33mx*\x1B[0m
//                     and \x1B[33mx*?\x1B[0m
//                   - \x1B[1;32mu\x1B[0m: unicode support (default)
//                   - \x1B[1;32mU\x1B[0m | \x1B[1;32m-u\x1B[0m: disable unicode
//                     support
...
//           |
//           = help: the argument should be the value parameter to search
// for"#]]);
//
//     query_ok("tag()", &expect![[r#"
//         ParsedQuery {
...
//                     ),
//                 },
//                 raw: "%r{a(b)?c+[a-z]} ? zz : %r{bb+} ? @F : %g{*.rs} ?
// @F[1,4] : @F[3..6]",             }
//             "#]],
//         );
//     }

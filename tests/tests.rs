...
//     static ref CWD_TWO: PathBuf = env::current_dir().expect("unable to get
// CWD")         .join(ANOTHER_FILE_DIR);
// }
//
// macro_rules! tag_out {
//     ($file:literal => $($set:tt),* $(,)?) => {
...
// // =====================================================================
// #[test]
// fn set_file_depth_not_deep_enough() {
//     wutag_clean();
//     wutag()
...
//
// #[test]
// fn set_case_overwrite_ignore_glob() {
//     wutag_clean();
//     wutag()
...
//
// #[test]
// fn set_case_overwrite_ignore_regex() {
//     wutag_clean();
//     wutag()
//         .args(&["-s", "-i", "-r", "set", ".*upper.*\\.rs",
// "tag_upper_regex"])         .assert()
//         .success()
//         .stdout(predicate::str::contains(expand_file!("sampd/UPPER.rs")))
//         .stdout(predicate::str::contains(expand_file!("sampd/upper-not.rs"
// ))); }
